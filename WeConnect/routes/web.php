...
Route::get(
    '/maps',
    [ProblemController::class, 'showMap']
)->name('user.open_map.view');


Route::post(
    '/addimage',
    [ProblemController::class, 'addimage']
);
Route::post(
    '/showimage',
    [ProblemController::class, 'showimage']
);
...
)->name('admin.manage_user');
Route::get(
    '/edituser/{id}',
    [UserController::class, 'viewEditUser']
