...
@section('content')
<!-- หัวข้อหลักของหน้า -->
<div class="text-left pl-6 mb-6">
    <h1 class="text-3xl font-bold text-black mb-2">Data Analytics</h1>
    <p class="text-black mt-4">
        กรอกพื้นที่ที่ต้องการทราบข้อมูล
        <span class="text-gray-500">(เช่น จังหวัด อำเภอ ตำบล)</span>
    </p>
</div>

<!-- jQuery และ Thailand.js -->
...
<main class="pt-4">
    <div class="container mx-auto px-4">
        <form action="{{ url('/dataanalytics') }}" method="post">
            @csrf

            <!-- ตำบล -->
            <div class="mb-4">
                <label for="sub_district" class="block text-gray-700 mb-1">ตำบล</label>
            ...
            <!-- อำเภอ -->
            <div class="mb-4">
                <label for="district" class="block text-gray-700 mb-1">อำเภอ</label>
                <input id="district" name="district" type="text" placeholder="อำเภอ"
                    class="w-full border px-4 py-2 rounded" required>
            </div>

            <!-- จังหวัด -->
            <div class="mb-4">
                <label for="province" class="block text-gray-700 mb-1">จังหวัด</label>
            ...
            <div class="flex justify-center mt-6">
                <button type="submit"
                    class="bg-green-500 text-white px-6 py-2 rounded-full text-lg hover:bg-green-600 transition duration-200">
                    ยืนยันข้อมูล
                </button>
            </div>
        </form>
...
<!-- Script เรียกใช้งาน autocomplete -->
<script>
    $.Thailand({
        database: 'https://earthchie.github.io/jquery.Thailand.js/jquery.Thailand.js/database/db.json',
