...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Kanit:wght@100;200;300;400;500;600;700;800;900&family=Outfit:wght@100..900&display=swap" rel="stylesheet">
...
<body>
    ...
    <header class="bg-orange-500 p-4 flex items-center z-50 relative">
        <button id="menu-btn" class="text-white text-2xl mr-2 ml-2">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="size-8" viewBox="0 0 24 24">
            ...
            <form>
                ...
                <div class="mb-3">
                    ...
                    <select id="position" class="form-control" required>
                        <option value="position"  disabled selected>กรุณาเลือกตำแหน่ง</option>
